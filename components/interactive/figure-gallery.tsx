...
export default function FigureGallery({ figureIds, label }: FigureGalleryProps) {
  ...
  return (
    <div>
      <div className="group relative flex h-[360px] sm:h-[520px] lg:h-[600px] w-full items-center justify-center overflow-hidden rounded-2xl border border-slate-200/90 bg-white p-3 sm:p-4 shadow-xs">
        <Image
          key={active.id}
